...
const PricingCard = ({
  ...
  return (
    <Card
      className={`bg-[#1A1F2C] border-[#2A2F3C] ${popular ? "relative" : ""}`}
    >
      {popular && (
      ...
      <CardContent className="p-6">
        ...
        <div className="text-3xl font-bold mb-2 text-white">
          {price}
          <span className="text-lg text-white/80">{period}</span>
        </div>
        ...
        <Button
          className={`w-full ${popular ? "bg-[#9b87f5] hover:bg-[#8a76e4] text-white" : ""}`}
        >
          Забронировать
        </Button>
      </CardContent>
        ...
        <TabsContent value="tournament">
          <Card className="bg-[#1A1F2C] border-[#2A2F3C]">
            <CardContent className="p-8">
              <h3 className="text-2xl font-bold mb-4 text-[#9b87f5] text-center">

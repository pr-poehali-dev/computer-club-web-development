  ...
  const features = [
    {
      ...
      description: "RTX 4080, процессоры Intel Core i9, 32GB RAM, 240Hz мониторы для максимальной производительности."
    },
    {
      icon: "Wifi",
      title: "Быстрый интернет",
      description: "Стабильное подключение 1 Гбит/с для игр без задержек и лагов."
    },
    {
      icon: "Trophy",
      title: "Турниры",
      description: "Регулярные соревнования по популярным дисциплинам с призовыми фондами."
    }
  ];
